  ...
  <v-dialog width="300" v-model="openDel">
    <v-card elevation="0" class="tw-p-2">
      <div class="tw-flex tw-justify-between">
        ...
        <div > <v-icon  @click="openDel = false;currentItem=null">mdi-close</v-icon></div>
      </div>
      <div>
  ...
  <v-dialog width="300" v-model="openEdit">
    <v-card  class="tw-p-2">
      ...
      <div  v-if="currentItem">
        ...
        <v-btn block @click.stop="editItem">Сохранить</v-btn>
      </div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('users', ['actReqwestUsers', 'actUserCreateLink', 'actUserDelete']),
    editItem() {
      this.actUserEdite(this.currentItem)
    },
    deleteItem() {
